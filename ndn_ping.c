/**
 * @brief       NDN Gateway Communication
 *
...
static int on_interest(ndn_block_t* interest)
{
    ...
    printf("------------ Communicating with gateway by UDP!!!! -----------");
    char *my_argv[] = {
        "udp",
        "2001:bb6:1d26:1200:8445:8c47:70cd:bce1",
        "8080",
        "22C",
        NULL
    };
...
static void run_server(const char* prefix, int id)
{
    ...
    printf("------------ Notify Gateway for new NDN name prefix!!!! -----------");
